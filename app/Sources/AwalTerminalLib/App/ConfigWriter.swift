...
enum ConfigWriter {
    ...
    /// Update or insert a key in the specified TOML config file.
    static func updateValue(key: String, value: String, in file: URL) {
    ...
    /// Remove a key from the specified TOML config file.
    static func removeValue(key: String, from file: URL) {

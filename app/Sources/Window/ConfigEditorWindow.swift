...
enum Theme {
    static let windowBg = NSColor(red: 22/255, green: 22/255, blue: 22/255, alpha: 1)
    static let editorBg = NSColor(red: 30/255, green: 30/255, blue: 30/255, alpha: 1)
    static let accent = NSColor(red: 79/255, green: 70/255, blue: 229/255, alpha: 1)
    static let accentSelection = NSColor(red: 79/255, green: 70/255, blue: 229/255, alpha: 0.15)
    static let barBorder = NSColor(white: 1, alpha: 0.06)
    static let textSelection = NSColor(red: 79/255, green: 70/255, blue: 229/255, alpha: 0.4)

    static let stringColor = NSColor(red: 143/255, green: 217/255, blue: 143/255, alpha: 1)
    static let numberColor = NSColor(red: 217/255, green: 166/255, blue: 89/255, alpha: 1)
    static let boolColor = NSColor(red: 140/255, green: 166/255, blue: 242/255, alpha: 1)
